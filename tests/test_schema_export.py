...
class SchemaAndExportTests(unittest.TestCase):
    def setUp(self):
        self.observation = FieldObservation(
            ...
            identificationConfidence="medio", identificationProbability=55, alertaHumanaOVehiculo=False,
    ...
    def test_observation_keeps_model_probability_as_percentage(self):
        self.assertEqual(self.observation.identificationProbability, 55)
